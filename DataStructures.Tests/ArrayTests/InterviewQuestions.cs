...
namespace DataStructures.Tests.ArrayTests
{
   public class InterviewQuestions
   {
      ...
      public void GetThreeLargestElements()
      {
         ...
         (int first, int second, int third) = DataStructures.Arrays.Array.GetThreeLargestElements(array);
         ...
         (first, second, third) = DataStructures.Arrays.Array.GetThreeLargestElements(array);
