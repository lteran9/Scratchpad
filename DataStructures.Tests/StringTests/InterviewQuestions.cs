...
namespace DataStructures.Tests.StringTests
{
   ...
   public class InterviewQuestions
   {
      ...
      public void Basic_UniqueTests()
      {
         ...
         Assert.True(DataStructures.Strings.String.HasAllUniqueCharacters(empty));
         // A null string cannot be unique because it does not have or represent a value
         Assert.False(DataStructures.Strings.String.HasAllUniqueCharacters(nullString));
         #endregion

         #region Medium
         // An empty string is unique by definition
         Assert.True(DataStructures.Strings.String.HasAllUniqueCharacters_ASCII(empty));
         // A null string cannot be unique because it does not have or represent a value
         Assert.False(DataStructures.Strings.String.HasAllUniqueCharacters_ASCII(nullString));
         #endregion

         #region Hard
         // An empty string is unique by definition
         Assert.True(DataStructures.Strings.String.HasAllUniqueCharacters_Linq(empty));
         // A null string cannot be unique because it does not have or represent a value
         Assert.False(DataStructures.Strings.String.HasAllUniqueCharacters_Linq(nullString));
         #endregion
      }
      ...
      public void Basic_PermutationTests()
      {
         ...
         Assert.True(DataStructures.Strings.String.CheckPermutation(empty, empty));
         // Null set cannot have permutations
         Assert.False(DataStructures.Strings.String.CheckPermutation(nullString, nullString));
         Assert.False(DataStructures.Strings.String.CheckPermutation(empty, nullString));
         Assert.False(DataStructures.Strings.String.CheckPermutation(nullString, empty));
         #endregion 

         #region Medium
         // Empty set can be a permutation of empty set
         Assert.True(DataStructures.Strings.String.CheckPermutation_HashSet(empty, empty));
         // Null set cannot have permutations
         Assert.False(DataStructures.Strings.String.CheckPermutation_HashSet(nullString, nullString));
         Assert.False(DataStructures.Strings.String.CheckPermutation_HashSet(empty, nullString));
         Assert.False(DataStructures.Strings.String.CheckPermutation_HashSet(nullString, empty));
         #endregion
      }
      ...
      public void IsPermutation_Easy()
      {
         ...
         Assert.False(DataStructures.Strings.String.CheckPermutation(original, almost));
         Assert.True(DataStructures.Strings.String.CheckPermutation(original, permutationOne));
         Assert.True(DataStructures.Strings.String.CheckPermutation(original, permutationTwo));
         Assert.False(DataStructures.Strings.String.CheckPermutation(original, irrelevant));
      }
      ...
      public void IsPermutation_Medium()
      {
         ...
         Assert.False(DataStructures.Strings.String.CheckPermutation_HashSet(original, permutationOne));
         // permutationTwo does not have character 'a' therefore it is not considered a permutation of the original string
         Assert.False(DataStructures.Strings.String.CheckPermutation_HashSet(original, permutationTwo));

         Assert.True(DataStructures.Strings.String.CheckPermutation_HashSet(original, permutationThree));
         Assert.True(DataStructures.Strings.String.CheckPermutation_HashSet(permutationThree, original));
      }
      ...
      public void IsPermutation_Hard()
      {
         ...
         Assert.True(DataStructures.Strings.String.CheckPermutation_Linq(original, permutationOne));
         Assert.True(DataStructures.Strings.String.CheckPermutation_Linq(original, permutationTwo));

         Assert.False(DataStructures.Strings.String.CheckPermutation_Linq(original, string.Empty));
         Assert.False(DataStructures.Strings.String.CheckPermutation_Linq(original, notPermutation));
      }
